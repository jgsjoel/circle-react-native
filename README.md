...
You'll need a backend server running locally. The API base URL is set in `src/api/client.ts` and the WebSocket URL in `src/services/websocket.ts` — both point to `192.168.1.5:8080` by default, change these to match your setup.
